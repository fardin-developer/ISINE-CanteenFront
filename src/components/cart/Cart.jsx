...
const Cart = () => {
    ...
    const handleOrder = async () => {
        try {
            ...
            const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiZnNkZmQiLCJ1c2VySWQiOiI2NjYzZjQ2NDA4Y2Y1NDVjNDQ5YWE2ZDQiLCJyb2xlIjoidXNlciIsImlhdCI6MTcyMDc4NTcxNCwiZXhwIjoxNzIwODcyMTE0fQ.TaiOprpCNTeQz2KCbByEoTlOyPuKkXdQ0uGGirO7iqY';
            ...
            const response = await axios.post('http://localhost:8000/api/v1/orders', orderData, config);
